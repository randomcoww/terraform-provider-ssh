...
- `critical_options` (Map of String) Map of critical options for certificate usage permissions.
- `extensions` (Map of String) Map of extensions for certificate usage permissions.
